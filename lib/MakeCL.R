makeCL = function(name, Info, sheet){
  ...
  p1 = paste("\nI am applying for the ", Position, "position, which I learned about ",Platform,". I am currently a Master's student majoring in statistics concentrating on Data Science and I will be graduating in May 2016. I believe that I am a good fit for the position because of my rich experience in statistical modeling and R, my outstanding communication skills, and, most importantly, my passion to learn new things.")
