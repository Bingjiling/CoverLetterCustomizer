makeCL = function(name, Info, sheet){
  ...
  p1 = paste("\nI am applying for the ", Position, "position, which I learned about ",Platform,". I am currently a Master's student at Columbia University majoring in statistics concentrating on Data Science and I will be graduating in May 2016. I believe that I am a good fit for the position because of my rich experience in statistical modeling and R, my outstanding communication skills, and, most importantly, my passion to learn new things.", sep="")
  ...
  p5 = paste("\n", Quality, "And I believe my background in statistics and coding make me a good fit. In closing I thank you for your time and consideration, and I hope to have the opportunity to discuss this opening with you in person. ", sep = "")
  tail = "\nYours sincerely,\n\nYanyu Zheng"
  ...
  output = paste(name,"CoverLeter.rtf",sep = "")
  rtf = RTF(output,font.size = 11)
  ## Build the rtf file
